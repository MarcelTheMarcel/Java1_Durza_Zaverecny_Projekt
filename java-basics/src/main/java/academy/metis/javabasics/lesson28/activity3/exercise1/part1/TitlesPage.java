...
public class TitlesPage {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                try {
                    ...
                    System.err.println("Skipping line with number format error: " + line);
                }
            }
        } catch (IOException e) {
            System.err.println("Error loading titles from file: " + filePath);
            throw e;
        }
    }
    ...
    public void listingAllTitles() {
        ...
        if (books.isEmpty()) {
            ...
            for (Book book : books) {
                System.out.println(book.getTitleId() + " | " + book.getTitle() + " | Author: " + book.getAuthorName() + " | ISBN: " + book.getIsbn() + " | Number of pages: " + book.getPageCount() + " | Available copies: " + book.getAvailableCopies());
            }
        }
        ...
        if (dvds.isEmpty()) {
            ...
            for (DVD dvd : dvds) {
                System.out.println(dvd.getTitleId() + " | " + dvd.getTitle() + " | Author: " + dvd.getAuthorName() + " | Number of chapters: " + dvd.getNumberOfTracks() + " | Length in minutes: " + dvd.getDurationInMinutes() + " | Available copies: " + dvd.getAvailableCopies());
            }
        }
    ...
    public void handleTitleDeletionProcess() {
        ...
        System.out.println("Select a title to delete by ID: ");
    ...
    public void updateTitles(Object title) {
        if (title instanceof Book) {
            updateFile(BOOKS_FILE_PATH, books);
        } else if (title instanceof DVD) {
            updateFile(DVDS_FILE_PATH, dvds);
