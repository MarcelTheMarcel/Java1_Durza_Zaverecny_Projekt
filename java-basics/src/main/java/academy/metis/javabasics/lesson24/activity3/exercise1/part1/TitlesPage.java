...
public class TitlesPage {
    ...
    public void listingAllTitles() {
        ...
        if (books.isEmpty()) {
            ...
            int index = 1;
            for (Book book : books) {
                System.out.println(index++ + " | " + book.getTitle() + " | Author: " + book.getAuthorName() + " | ISBN: " + book.getIsbn() + " | Number of pages: " + book.getPageCount() + " | Available copies: " + book.getAvailableCopies());
            }
        }
        ...
        if (dvds.isEmpty()) {
            ...
            int index = 1 + books.size(); // Continue numbering from where books ended
            for (DVD dvd : dvds) {
                System.out.println(index++ + " | " + dvd.getTitle() + " | Author: " + dvd.getAuthorName() + " | Number of chapters: " + dvd.getNumberOfTracks() + " | Length in minutes: " + dvd.getDurationInMinutes() + " | Available copies: " + dvd.getAvailableCopies());
            }
        }
